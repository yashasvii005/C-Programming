...
void subtractMatrices(int firstMatrix[10][10], int secondMatrix[10][10], int resultMatrix[10][10], int rows, int columns) {
...
int main() {
    ...
    printf("\nResultant Matrix (Subtraction of the matrices):\n");
